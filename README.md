...
| 242 | [Valid Anagram](./01_Arrays_and_Hashing/242_Valid_Anagram/) | 🟢 | ✅ | 💡 | - | Count frequency of characters. |
| 001 | [Two Sum](./01_Arrays_and_Hashing/001_Two_Sum/) | 🟢 | ✅ | 💡 | - | `unordered_map` lookup. |
| 049 | [Group Anagrams](./01_Arrays_and_Hashing/049_Group_Anagrams/) | 🟡 | ✅ | 💡 | - | Use sorted string as key. |
| 347 | [Top K Frequent Elements](./01_Arrays_and_Hashing/347_Top_K_Frequent_Elements/) | 🟡 | ✅ | 💡 | - | Bucket sort or priority queue. |
| 271 | [Encode and Decode Strings](./01_Arrays_and_Hashing/271_Encode_And_Decode_Strings/) | 🟡 | ✅ | 💡 | - | Store length of string + delimiter. |
